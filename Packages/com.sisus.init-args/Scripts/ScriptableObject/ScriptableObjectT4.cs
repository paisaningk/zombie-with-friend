...
namespace Sisus.Init
{
	...
	/// or <see cref="InstantiateExtensions.Instantiate{TScriptableObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}">instantiated</see>
	/// with four arguments passed to the <see cref="Init"/> method of the created instance.
	/// <para>
	...
	/// </para>
	/// <para>
	/// Instances of classes inheriting from <see cref="ScriptableObject{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}"/> receive the arguments
	...
	public abstract class ScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		: ScriptableObject, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>, IInitializable
		#if UNITY_EDITOR
		...
		#endif
	{
		...
		protected object this[[DisallowNull] string memberName]
		{
			set
			{
				...
				Inject<ScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>(this, memberName, value);
			}
		}
		...
		bool IInitializable.Init(Context context)
		{
			...
			if(InitArgs.TryGet(context, this, out TFirstArgument firstArgument, out TSecondArgument secondArgument, out TThirdArgument thirdArgument, out TFourthArgument fourthArgument))
			{
				...
				HandleValidate(firstArgument, secondArgument, thirdArgument, fourthArgument);
				#endif
		...
		private void HandleValidate(TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument, TFourthArgument fourthArgument)
		{
			#if DEBUG || INIT_ARGS_SAFE_MODE
			#if UNITY_EDITOR
