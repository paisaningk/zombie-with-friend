## [3.8.2] - 2026-07-03
- Fixed Using deprecated API for SceneHandle in Unity 6000.5
- Fixed warnings due to serialization hierarchy in Unity 6000.5

## [3.8.1] - 2026-05-31
- Fixed Null Ref happening occasionally when Finding Soap SO
- Fixed indexer in ScriptableList not issuing events
- Added SetItems method to replace items from a ScriptableList
- Modified default ResetTiming to be OnPlayStart instead of OnSceneUnload

## [3.8.0] - 2026-02-22
- Fixed auto path refresh when using single column layout project window
- Modified Event Listeners to have virtual protected methods
- Modified Scriptable Variables and Collections reset to be on scene unload
