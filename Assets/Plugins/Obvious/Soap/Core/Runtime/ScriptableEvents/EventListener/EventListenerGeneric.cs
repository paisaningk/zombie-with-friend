...
namespace Obvious.Soap
{
    public abstract class EventListenerGeneric<T> : EventListenerBase
    {
        ...
        internal virtual void OnEventRaised(ScriptableEvent<T> eventRaised, T param, bool debug = false)
        {
        ...
        protected virtual IEnumerator Cr_DelayInvokeResponse(ScriptableEvent<T> eventRaised, EventResponse<T> eventResponse, T param,
            bool debug)
        {
        ...
        protected virtual void InvokeResponse(ScriptableEvent<T> eventRaised, EventResponse<T> eventResponse, T param, bool debug)
        {
